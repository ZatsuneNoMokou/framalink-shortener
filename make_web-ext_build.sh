...
cd tmp
sed		-e 's/\"id\"\: \"framalinkshortener_dev\@zatsunenomokou\.eu\"/\"id\"\: \"framalinkshortener\@zatsunenomokou\.eu\"/g' \
		-e 's/\"name\"\: \"Framalink shortener (Dev)\"/\"name\"\: \"Framalink shortener\"/g' \
		-e 's/\"short_name\"\: \"FramalinkShortenerDev\"/\"short_name\"\: \"FramalinkShortener\"/g' \
		-e 's/\"update_url\"\: \".*\",//gi' \
		-e '/^\s*$/d' \
